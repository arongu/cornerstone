...
//        Mockito.when(accountManager.create(Mockito.anyString(), Mockito.anyString(), Mockito.anyBoolean(), Mockito.anyBoolean(), Mockito.any(SYSTEM_ROLE_ENUM.class))).thenReturn(1);
//
//
...
//        Mockito.when(accountManager.create(Mockito.anyString(), Mockito.anyString(), Mockito.anyBoolean(), Mockito.anyBoolean(), Mockito.any(SYSTEM_ROLE_ENUM.class))).thenThrow(new CreationException(mail));
//
//
//        final Response response = accountManagerRestService.create(accountEmailPassword);
//        final ErrorResponse er  = (ErrorResponse) response.getEntity();
